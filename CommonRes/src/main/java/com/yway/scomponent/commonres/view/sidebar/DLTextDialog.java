package com.yway.scomponent.commonres.view.sidebar;
...
public class DLTextDialog {
    ...
    public DLTextDialog(Context context, int weight, int hight, int textColor, float textSize, Drawable bg){
        select_dialog = new Dialog(context, R.style.public_sidebar_dialog);
        View view = LayoutInflater.from(context).inflate(R.layout.public_dl_dialog, null);
