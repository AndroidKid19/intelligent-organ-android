 ...
 * @Package: com.fwzx.scomponent.commonres.view.layout
 * @ClassName: FlowRadioGroup
 * @Description:流式布局的RadioGroup
 * @Author: Yuan
 * @CreateDate: 2020/12/8 11:58
 * @UpdateUser: 更新者
 * @UpdateDate: 2020/12/8 11:58
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
