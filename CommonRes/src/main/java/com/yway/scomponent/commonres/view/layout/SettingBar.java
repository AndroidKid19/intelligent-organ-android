...
public final class SettingBar extends FrameLayout {
    ...
    public SettingBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.public_widget_setting_bar, this);
        ...
        // 是否加粗设置
        if (array.hasValue(R.styleable.SettingBar_bar_leftBold)) {
            setLeftTextBold(array.getBoolean(R.styleable.SettingBar_bar_leftBold,false));
        }

        if (array.hasValue(R.styleable.SettingBar_bar_rightBold)) {
            setRightTextBold(array.getBoolean(R.styleable.SettingBar_bar_rightBold,false));
        }
    ...
    public SettingBar setLeftTextBold(boolean bold) {
        if (bold){
    ...
    public SettingBar setRightTextBold(boolean bold) {
        if (bold){
            mRightView.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
        }else{
            mRightView.setTypeface(Typeface.defaultFromStyle(Typeface.NORMAL));
        }
        return this;
    }
