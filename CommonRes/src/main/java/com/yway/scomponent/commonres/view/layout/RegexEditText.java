...
public class RegexEditText extends AppCompatEditText implements InputFilter {
    ...
    /** 小数位数 */
    public static int REGEX_DECIMAL_NUM = 5;
    ...
    public static String regexDecimal(int digit){
        String REGEX_DECIMAL = "^\\d+\\.{0,1}\\d{0,"+digit+"}$";
    ...
    protected void initialize(Context context, AttributeSet attrs) {
        ...
        REGEX_DECIMAL_NUM = array.getInt(R.styleable.RegexEditText_decimalNum, 5);
        /** 非负数并且小数限制5位 */
        String REGEX_DECIMAL = "^\\d+\\.{0,1}\\d{0,"+REGEX_DECIMAL_NUM+"}$";
    ...
    public void setDecimalNum(int decimalNum){
        this.REGEX_DECIMAL_NUM = decimalNum;
    }
    ...
    public static void main(String[] args) {
        String str = "0000";
        String pattern = "^\\d+\\.{0,1}\\d{0,5}$";
        String pattern2 = "^(0|[1-9][0-9]*)$";
