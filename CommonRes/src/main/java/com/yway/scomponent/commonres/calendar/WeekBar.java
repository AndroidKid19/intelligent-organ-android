 ...
 */
package com.yway.scomponent.commonres.calendar;
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.yway.scomponent.commonres.calendar.WeekBar".equals(getClass().getName())) {
            LayoutInflater.from(context).inflate(R.layout.public_week_bar, this, true);
        }
    }
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.yway.scomponent.commonres.calendar.WeekBar".equalsIgnoreCase(getClass().getName())) {
