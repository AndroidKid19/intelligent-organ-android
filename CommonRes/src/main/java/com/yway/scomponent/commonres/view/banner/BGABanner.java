...
import com.yway.scomponent.commonres.view.banner.transformer.BGAPageTransformer;
import com.yway.scomponent.commonres.view.banner.transformer.TransitionEffect;
...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private int mPointDrawableResId = R.drawable.public__banner_selector_point_solid;
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.BGABanner_banner_pointDrawable) {
            mPointDrawableResId = typedArray.getResourceId(attr, R.drawable.public__banner_selector_point_solid);
    ...
    public void setData(List<View> views, List<? extends Object> models, List<String> tips) {
        ...
        if (mAutoPlayAble && views.size() <= 1 && mHackyViews == null) {
            mAutoPlayAble = false;
        }
    ...
    public void setData(List<? extends Object> models, List<String> tips) {
        setData(R.layout.public_banner_item_image, models, tips);
    }
