...
public class XLHRatingBar extends LinearLayout {
    ...
    private String mRatingViewClassName = "com.yway.scomponent.commonres.view.star.SimpleRatingView";
    ...
    private void initData(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            if(TextUtils.isEmpty(mRatingViewClassName)){
                mRatingViewClassName = "com.yway.scomponent.commonres.view.star.SimpleRatingView";
            }
        }
        try {
            mIRatingViews.clear();
