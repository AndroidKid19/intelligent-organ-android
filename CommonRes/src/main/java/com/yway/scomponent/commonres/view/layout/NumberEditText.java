 ...
 */
public final class NumberEditText extends RegexEditText
    ...
    protected void initialize(Context context, AttributeSet attrs) {
        ...
        mClearDrawable = DrawableCompat.wrap(ContextCompat.getDrawable(context, R.drawable.public_ic_input_delete));
    ...
    public void onTextChanged(final CharSequence s, final int start, final int before, final int count) {
        ...
        if (s != null && count == 1 && s.toString().equals("0")){
            this.setText("0.");
        }
        if (s !=null && !s.toString().equals("") && count == 1 ){
