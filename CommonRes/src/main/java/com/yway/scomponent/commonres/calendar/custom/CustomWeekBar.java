package com.yway.scomponent.commonres.calendar.custom;
...
import com.yway.scomponent.commonres.calendar.WeekBar;
...
public class CustomWeekBar extends WeekBar {
    ...
    public CustomWeekBar(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.public_custom_week_bar, this, true);
