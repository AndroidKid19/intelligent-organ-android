...
public class MultipleStatusView extends RelativeLayout {
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyViewResId = a.getResourceId(R.styleable.MultipleStatusView_emptyView, R.layout.public_layout_empty_view);
        mErrorViewResId = a.getResourceId(R.styleable.MultipleStatusView_errorView, R.layout.public_layout_error_view);
        mLoadingViewResId = a.getResourceId(R.styleable.MultipleStatusView_loadingView, R.layout.public_layout_loading_view);
        mNoNetworkViewResId = a.getResourceId(R.styleable.MultipleStatusView_noNetworkView, R.layout.public_layout_network_view);
    ...
    public final void showEmpty(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mEmptyView) {
            ...
            if (!StringUtils.isEmpty(msgContent)){
                TextView mTvContent = mEmptyView.findViewById(R.id.tv_msg_content);
                mTvContent.setText(msgContent);
            }
        }
     ...
     * @param content 提示内容
     */
    public final void showEmpty(View view, ViewGroup.LayoutParams layoutParams,String content) {
        checkNull(view, "Empty view is null.");
        checkNull(layoutParams, "Layout params is null.");
        changeViewStatus(STATUS_EMPTY);
        if (null == mEmptyView) {
