package com.yway.scomponent.commonres.view.tablayout;
...
import com.yway.scomponent.commonres.view.tablayout.listener.CustomTabEntity;
import com.yway.scomponent.commonres.view.tablayout.listener.OnTabSelectListener;
import com.yway.scomponent.commonres.view.tablayout.utils.FragmentChangeManager;
import com.yway.scomponent.commonres.view.tablayout.utils.UnreadMsgUtils;
import com.yway.scomponent.commonres.view.tablayout.widget.MsgView;
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.LEFT) {
                tabView = View.inflate(mContext, R.layout.public_layout_tab_left, null);
            } else if (mIconGravity == Gravity.RIGHT) {
                tabView = View.inflate(mContext, R.layout.public_layout_tab_right, null);
            } else if (mIconGravity == Gravity.BOTTOM) {
                tabView = View.inflate(mContext, R.layout.public_layout_tab_bottom, null);
            } else {
                tabView = View.inflate(mContext, R.layout.public_layout_tab_top, null);
            }
