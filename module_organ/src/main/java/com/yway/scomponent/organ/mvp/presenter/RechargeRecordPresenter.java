 ...
 */
@FragmentScope
public class RechargeRecordPresenter extends BasePresenter<RechargeRecordContract.Model, RechargeRecordContract.View> {
    @Inject
    ...
    @Inject
    public RechargeRecordPresenter(RechargeRecordContract.Model model, RechargeRecordContract.View rootView) {
