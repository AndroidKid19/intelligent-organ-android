 ...
 */
@FragmentScope
public class SubscribeApplyPresenter extends BasePresenter<SubscribeApplyContract.Model, SubscribeApplyContract.View> {
    @Inject
    ...
    @Inject
    SubscribeApplyAdapter mAdapter;

    @Inject
    public SubscribeApplyPresenter(SubscribeApplyContract.Model model, SubscribeApplyContract.View rootView) {
        super(model, rootView);
    }

    public void getMeetingRecordApprovalingList(Map<String, Object> params, boolean pullToRefresh) {
        if (pullToRefresh) {
            pageNo = 1;
        } else {
        ...
        mModel.getMeetingRecordApprovalingList(params)
