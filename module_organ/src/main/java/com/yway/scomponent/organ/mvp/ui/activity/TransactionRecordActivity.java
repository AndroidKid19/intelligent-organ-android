...
import com.yway.scomponent.organ.di.component.DaggerTransactionRecordComponent;
import com.yway.scomponent.organ.mvp.contract.TransactionRecordContract;
import com.yway.scomponent.organ.mvp.presenter.TransactionRecordPresenter;
 ...
 * 交易记录
 */
@Route(path = RouterHub.HOME_TRANSACTIONRECORDACTIVITY)
public class TransactionRecordActivity extends BaseActivity<TransactionRecordPresenter> implements TransactionRecordContract.View {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerTransactionRecordComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.organ_activity_transaction_record; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
    ...
    private void initViewPager() {
        ...
        mViewPageContent.setCurrentItem(formPage);
    }
