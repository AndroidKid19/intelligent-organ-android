...
import com.yway.scomponent.organ.di.component.DaggerApprovedComponent;
...
import com.yway.scomponent.organ.mvp.presenter.ApprovedPresenter;
 ...
 * 管理员 已审批
 */
public class ApprovedFragment extends BaseFragment<ApprovedPresenter> implements ApprovedContract.View {
    /**
     * 多状态view
     */
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerApprovedComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.organ_fragment_approved, container, false);
    }
    ...
    private OnRefreshListener mOnRefreshListener = refreshLayout -> {
        mPresenter.getMeetingRecordApprovaedList(paramMap, true);
    };
    ...
    private OnLoadMoreListener mOnLoadMoreListener = refreshLayout -> {
        mPresenter.getMeetingRecordApprovaedList(paramMap, false);
    };
