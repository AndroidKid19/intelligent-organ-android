 ...
 * 管理员 待审批
 */
public class SubscribeApplyFragment extends BaseFragment<SubscribeApplyPresenter> implements SubscribeApplyContract.View {
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerSubscribeApplyComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.organ_fragment_subscribe_apply, container, false);
    }
