 ...
 */
@FragmentScope
public class BeforePreparePresenter extends BasePresenter<BeforePrepareContract.Model, BeforePrepareContract.View> {
    @Inject
    ...
    @Inject
    public BeforePreparePresenter(BeforePrepareContract.Model model, BeforePrepareContract.View rootView) {
        super(model, rootView);
    }


    public void getMeetingRecordReadyingList(Map<String, Object> params, boolean pullToRefresh) {
        if (pullToRefresh) {
            pageNo = 1;
        } else {
        ...
        mModel.getMeetingRecordReadyingList(params)
