 ...
 */
@FragmentScope
public class ConfirmMeetingModel extends BaseModel implements ConfirmMeetingContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ConfirmMeetingModel(IRepositoryManager repositoryManager) {
