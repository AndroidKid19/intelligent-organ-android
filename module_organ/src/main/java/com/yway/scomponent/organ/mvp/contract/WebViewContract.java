...
public interface WebViewContract {
    ...
    interface View extends IView {
        ...
        void createArticleFavoritesCallBack();

        void isFavoritesCallBack(String favoritesStatus);
    }

    //Model层定义接口,外部只需关心Model返回的数据,无需关心内部细节,即是否使用缓存
    interface Model extends IModel {

        Observable<BaseResponse> createArticleFavorites(Map<String, Object> params);

        Observable<BaseResponse> cancelArticleFavorites(Map<String, Object> params);

        Observable<BaseResponse<FavoritesBean>> queryUserIsArticleFavorites(Map<String, Object> params);
    }
}