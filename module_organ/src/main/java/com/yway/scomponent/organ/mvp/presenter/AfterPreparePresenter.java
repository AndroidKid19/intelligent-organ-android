 ...
 */
@FragmentScope
public class AfterPreparePresenter extends BasePresenter<AfterPrepareContract.Model, AfterPrepareContract.View> {
    @Inject
    ...
    @Inject
    public AfterPreparePresenter(AfterPrepareContract.Model model, AfterPrepareContract.View rootView) {
        super(model, rootView);
    }

    public void getMeetingRecordReadyedList(Map<String, Object> params, boolean pullToRefresh) {
        if (pullToRefresh) {
            pageNo = 1;
        } else {
        ...
        mModel.getMeetingRecordReadyedList(params)
