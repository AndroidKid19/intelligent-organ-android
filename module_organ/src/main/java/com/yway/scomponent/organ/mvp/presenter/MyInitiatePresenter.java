 ...
 */
@FragmentScope
public class MyInitiatePresenter extends BasePresenter<MyInitiateContract.Model, MyInitiateContract.View> {
    @Inject
    ...
    @Inject
    public MyInitiatePresenter(MyInitiateContract.Model model, MyInitiateContract.View rootView) {
