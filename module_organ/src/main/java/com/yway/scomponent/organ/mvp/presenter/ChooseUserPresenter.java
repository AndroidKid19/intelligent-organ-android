 ...
 */
@ActivityScope
public class ChooseUserPresenter extends BasePresenter<ChooseUserContract.Model, ChooseUserContract.View> {
    @Inject
    ...
    @Inject
    public ChooseUserPresenter(ChooseUserContract.Model model, ChooseUserContract.View rootView) {
