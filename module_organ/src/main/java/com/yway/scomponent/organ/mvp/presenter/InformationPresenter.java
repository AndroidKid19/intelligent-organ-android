...
public class InformationPresenter extends BasePresenter<InformationContract.Model, InformationContract.View> {
    ...
    @Inject
    public InformationPresenter(InformationContract.Model model, InformationContract.View rootView) {
        super(model, rootView);
    }


    public void queryArticlePublishPageList(Map<String, Object> params, boolean pullToRefresh){
        if (pullToRefresh){
            pageNo = 1;
        }else{
