 ...
 */
@ActivityScope
public class ConferenceRoomModel extends BaseModel implements ConferenceRoomContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ConferenceRoomModel(IRepositoryManager repositoryManager) {
