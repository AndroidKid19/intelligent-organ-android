...
public class PickerOptions {
    ...
    //constant
    private static final int PICKER_VIEW_BTN_COLOR_NORMAL = 0xFF00B075;
    private static final int PICKER_VIEW_BTN_COLOR_CLOSE = 0xFF999999;
    private static final int PICKER_VIEW_BG_COLOR_TITLE = 0xFFF9F9F9;
    private static final int PICKER_VIEW_COLOR_TITLE = 0xFF222222;
    ...
    public int textColorCancel = PICKER_VIEW_BTN_COLOR_CLOSE;//取消按钮颜色
    ...
    public int textColorOut = 0xFF818181; //分割线以外的文字颜色
    public int textColorCenter = 0xFF222222; //分割线之间的文字颜色
    public int dividerColor = 0xFFF7F7F8; //分割线的颜色
    public int outSideColor = -1; //显示时的外部背景色颜色,默认是灰色

    public float lineSpacingMultiplier = 2.1f; // 条目间距倍数 默认1.6
    ...
    public int itemsVisibleCount = 6; //最大可见条目数
