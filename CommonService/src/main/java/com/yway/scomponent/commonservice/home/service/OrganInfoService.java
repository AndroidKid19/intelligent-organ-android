 ...
 */
package com.yway.scomponent.commonservice.home.service;
 ...
 * ================================================
 */
public interface OrganInfoService extends IProvider {
    OrganInfo getInfo();
    OrganInfo getAddressBookInfo();
    OrganInfo getWorkPanelInfo();
}
