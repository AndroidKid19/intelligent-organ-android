...
public class ProportionUtil {
     ...
     * @return
     */
    public static String proportionDouble(Double divisor, Double dividend, Integer bit) {
     ...
     * @return
     */
    public static String proportionDoubleNot(Double divisor, Double dividend, Integer bit) {
        if (dividend == null || divisor == null || bit == null)
            return null;
        NumberFormat numberFormat = NumberFormat.getInstance();
        // 设置精确到小数点后2位
