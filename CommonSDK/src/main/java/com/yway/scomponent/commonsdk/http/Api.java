package com.yway.scomponent.commonsdk.http;
...
public interface Api {
    class Domain{
        public static final String WHEELAPI = "wheelapi";
        public static final String APP_DOMAIN = BuildConfig.HOST_ROOT;
    }
    //请求成功
    String REQUEST_SUCCESS = "0000";
    // 错误码
    int ERROR_LOGIN_OUT = 99999;
