...
import com.yway.scomponent.user.mvp.ui.listener.OnItemLongClickListener;
import com.yway.scomponent.user.mvp.ui.listener.OnPhotoItemClickListener;
...
public class GridImageAdapter extends
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.user_item_recycle_filter_image,
                viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.mipmap.public_ic_add_image);
...
//                        .diskCacheStrategy(DiskCacheStrategy.ALL)
    ...
    public void setOnItemClickListener(OnPhotoItemClickListener l) {
