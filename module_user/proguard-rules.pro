...
# 混淆规则在 arms moudule下的proguard-rules.pro中,混淆前先参阅https://github.com/AndroidKid19Coding/MVPArms/wiki#1.5
...
-keepclassmembers class * extends androidx.appcompat.app.AppCompatActivity {                        # 保持自定义控件类不被混淆
...
-keep class com.fatalsignal.outsourcing.commonsdk.** { *; }

-keep class com.fatalsignal.outsourcing.commonservice.** { *; }
...
-keep class com.yway.scomponent.user.mvp.ui.view.** { *; }
-keep class com.yway.scomponent.user.mvp.model.entity.** { *; }
-keep class com.yway.scomponent.commonsdk.core.UserInfoBean.** { *; }